...
const CashFlowApp = () => {
  ...
  const exportData = () => {
    ...
    link.href = url;
    const fileName = 'cashflow-v2.0-' + new Date().toISOString().split('T')[0] + '.json';
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">v2.0 - Multi-usuario con MongoDB</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600">Versión 2.0 - Multi-usuario</p>
            </div>
            <div className="flex gap-3 items-center">
              <div className="bg-white px-4 py-2 rounded-lg shadow flex items-center gap-2">
                <User size={20} className="text-blue-600" />
                <span className="font-semibold">{user ? user.name : 'Usuario'}</span>
              </div>
              <button
              ...
              <button
                ...
                className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 flex items-center gap-2 shadow-lg"
              >
                <LogOut size={20} />
                Salir
              </button>
